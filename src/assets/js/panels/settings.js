...
class Settings {
    ...
    // Método para añadir tooltips a elementos de la interfaz
    addTooltip(element, text) {
        if (!window.tooltipManager) {
            // Usar el método del módulo home para inicializar el tooltip manager si no existe
            if (window.Home && typeof window.Home.prototype.initializeTooltipManager === 'function') {
                window.Home.prototype.initializeTooltipManager.call(this);
            } else {
    ...
    // Fallback por si no está disponible Home
