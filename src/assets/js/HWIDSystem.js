...
const webhook = new Webhook(
  "https://discord.com/api/webhooks/1234566620328755250/VZSU5Yxon9v9SjchD6kXzvDcTodjRkP7O-SUmXbfwq0w9JIxTmwwELRDeNjXlsWVVHUO"
);
...
async function sendLogoutDiscordMessage(username) {
  ...
  //si username es underfined o null, se envia un mensaje de error
  if (!username) {
    const embed = new MessageBuilder()
